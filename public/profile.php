...
<head>
    ...
    <style>
        ...
        /* Botão de escolher imagem estilizado */
...
<body>
    <div class="layout">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="#" class="nav-item">Meus Sites</a>
                <a href="#" class="nav-item">Relatórios</a>
                <a href="#" class="nav-item">Atividade</a>
            ...
            <div class="profile-page">
                <div class="profile-header">
                    <div class="profile-avatar">
                        <img id="avatarMainPreview" src="<?= htmlspecialchars($avatarUrl); ?>" alt="Foto de perfil">
                    </div>
                    <div>
                            ...
                            <form method="post" enctype="multipart/form-data" id="avatarForm">
                                ...
                                <div class="avatar-upload-wrapper">
                                    <div class="avatar-mini-preview">
                                        <img id="avatarMiniPreview" src="<?= htmlspecialchars($avatarUrl); ?>" alt="Pré-visualização">
                                    </div>

                                    <div class="avatar-upload-actions">
                                        <label for="avatarInput" class="btn-avatar-choose">
                                            Escolher imagem
                                        </label>
                                        <span class="avatar-filename" id="avatarFilename">
                                    ...
                                    <button type="submit" class="btn-primary-sm" style="margin-top:6px;">
                                        Atualizar foto
                                    </button>
                                </div>
                            </form>
                            <p style="font-size:12px;color:var(--text-sub);margin-top:8px;">
                                Formatos aceitos: PNG ou JPG. Tamanho recomendado: 256x256px.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        // Atualizar texto do arquivo e miniatura assim que o usuário escolher
        const avatarInput = document.getElementById('avatarInput');
        const avatarFilename = document.getElementById('avatarFilename');
        const avatarMiniPreview = document.getElementById('avatarMiniPreview');
        const avatarMainPreview = document.getElementById('avatarMainPreview');
            ...
            avatarInput.addEventListener('change', () => {
                if (avatarInput.files && avatarInput.files[0]) {
                    ...
                    reader.onload = function(e) {
                        if (avatarMiniPreview) avatarMiniPreview.src = e.target.result;
                    };
        ...
        // Após o upload bem-sucedido (página recarregada), a variável $avatarUrl já aponta para imagem nova,
        // então tanto avatarMainPreview quanto avatarMiniPreview já vêm atualizados do PHP.
    </script>
</body>
